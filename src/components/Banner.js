...
const Banner = () => {
    return (
        <div className="hero min-h-screen bg-base-200">
            <div className="my-6 flex flex-col md:flex-row md:space-x-10 lg:space-x-24 xl:space-x-44 items-center justify-around">
                <div className='mx-auto p-5 order-last md:order-first'>
